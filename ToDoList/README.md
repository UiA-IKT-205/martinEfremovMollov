...
<img src="https://github.com/UiA-IKT-205/martinEfremovMollov/blob/main/ToDoList/examples/Screenshot%202021-04-08%20at%2014.16.19.png" alt="drawing" width="750"/>

<img src="https://github.com/UiA-IKT-205/martinEfremovMollov/blob/main/ToDoList/examples/Screenshot%202021-04-08%20at%2014.17.08.png" alt="drawing" width="750"/>
...
- Checkbox for each list item/task (indicates status of that item/task)
- Button for deleting done (checked) item/task
...
Currently the app works as intended. The only known bug, as of now, is when a user deletes all done tasks the progress bar goes to 100, however when you check and uncheck an item it goes back to normal. This is being fixed in a future commit.
